        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 dark:bg-gray-800">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    class="block w-3/4 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                />
            ...
            <div class="mt-6 flex justify-end">
                <x-secondary-button x-on:click="$dispatch('close')" class="dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:border-gray-500">
                    {{ __('Batal') }}
                </x-secondary-button>
