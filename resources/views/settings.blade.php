...
<body class="bg-gray-50 h-full overflow-hidden">
    ...
    <div class="flex-1 sm:ml-64 h-screen">
        <main class="h-full p-6 md:p-10 overflow-y-auto">
            ...
            class="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow p-8 mt-2">
                <div class="border-b border-gray-200 mb-8">
                    <div class="flex space-x-8" aria-label="Tabs">
                        <button type="button" @click="tab = 'umum'" :class="tab === 'umum' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500'" class="py-2 px-1 border-b-2 font-medium text-sm focus:outline-none">Umum</button>
                        <button type="button" @click="tab = 'profile'" :class="tab === 'profile' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500'" class="py-2 px-1 border-b-2 font-medium text-sm focus:outline-none">Profile</button>
                    </div>
                </div>
                <!-- Tab Umum -->
                <form x-show="tab === 'umum'" class="space-y-8" x-cloak>
                    <div class="space-y-6">
                        <div>
                            <label for="language" class="block text-sm font-medium text-gray-500 mb-2">Bahasa</label>
                            <select id="language" name="language" class="block w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                <option selected>Indonesia (Default)</option>
                                <option>English</option>
                            </select>
                        </div>
                        <div>
                            <label for="timezone" class="block text-sm font-medium text-gray-500 mb-2">Zona Waktu</label>
                            <select id="timezone" name="timezone" class="block w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-2">Tema Layar</label>
                            <div class="flex space-x-4">
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-gray-900">Light Mode</span>
                                </label>
                                <label class="flex items-center cursor-pointer">
                                    <input type="radio" name="theme" value="dark" class="form-radio accent-indigo-500" :checked="theme === 'dark'" @change="setTheme('dark')">
                                    <span class="ml-2 text-sm font-medium text-gray-400">Dark Mode</span>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div x-show="tab === 'profile'" x-cloak class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Profile Card -->
                    <div class="bg-white border rounded-2xl p-8 flex flex-col items-center">
                        <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Profile" class="w-32 h-32 rounded-full object-cover mb-4">
                        <div class="text-center">
                            <div class="font-semibold text-lg">Anna White</div>
                            <div class="text-gray-500 text-sm mt-1">D4 Teknik Multimedia dan Jaringan</div>
                            <div class="text-gray-700 text-base mt-1">Politeknik Negeri Ujung Pandang</div>
                        </div>
                    ...
                    <!-- Edit Profile Form -->
                    <form class="bg-white border rounded-2xl p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 text-sm" value="Anna">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nama belakang</label>
                                <input type="text" class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 text-sm" value="White">
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-400 text-sm" value="annawhite@asite.com" disabled>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Kata Sandi</label>
                                <input type="password" class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-400 text-sm" placeholder="Change Password">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Negara</label>
                                <select class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 text-sm">
                                    <option selected>Indonesia</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-8">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Posisi atau Pekerjaan</label>
                            <select class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 px-3 text-gray-900 text-sm">
